<script setup>
/**
 * RegistryTab.vue — Sprint 3 G4 Rewrite
 *
 * Full local Docker registry management. Migrated from appmanager store
 * to dedicated useRegistryStore with Sprint 3 enhancements.
 *
 * Features:
