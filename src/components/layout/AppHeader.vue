...
<template>
  <header class="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4 lg:px-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <router-link to="/" class="flex items-center gap-2">
          <div class="w-8 h-8 bg-cube-600 rounded-lg flex items-center justify-center">
            <span class="text-white font-bold text-sm">C</span>
          </div>
          <span class="font-semibold text-gray-900 dark:text-white hidden sm:block">CubeOS</span>
        </router-link>
      </div>
      ...
      <div class="hidden md:flex items-center gap-6 text-sm">
        ...
        <div v-if="systemStore.temperature" class="flex items-center gap-2 text-gray-600 dark:text-gray-300">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative">
          ...
          >
            <div class="w-8 h-8 bg-cube-100 dark:bg-cube-900 rounded-full flex items-center justify-center">
              <span class="text-cube-600 dark:text-cube-400 font-medium text-sm">
    ...
    <div 
      v-if="showMobileMenu"
      class="lg:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-4 px-4"
    >
      <nav class="space-y-2">
        <router-link 
          to="/" 
          class="block px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200"
